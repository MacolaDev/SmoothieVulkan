...
namespace Smoothie
{
	...
	public:
		...
		inline VkDescriptorSetLayout getDescriptorLayout() const { return m_DescriptorSetLayout; }
	...
	// {
	// 	int size = 0; //Size of this object in bytes. If it's an array, this is the size of the entire array in bytes.
	...
	// //that can all be potentially conflicting with one another.
	...
	//
	// 	//Reflected buffers.
	// 	//Key is it's binding inside the descriptor set.
