...
int Smoothie::DeferredRendering::LoadableObject_Shader::create()
{
    return 0;
}

void Smoothie::DeferredRendering::LoadableObject_Shader::destroy()
{
    shader.destroy();
}

int Smoothie::DeferredRendering::LoadableObject_Shader::recreate()
{
