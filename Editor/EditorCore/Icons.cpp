...
int SmoothieEditor::Icon::create(const std::string& path)
{
    ...
    TextureID = ImGui_ImplVulkan_AddTexture(
        getCore().draw_manager->getSampler("ClampToEdgeLINEAR"),
		imageView,
...
void SmoothieEditor::Icons::destroy()
{
	object_select_icon.destroy();
    camera_icon.destroy();
}
