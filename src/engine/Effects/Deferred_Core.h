...
#include "screen-space-effects/screen-space-effects.h"
...
namespace Smoothie
{
	...
	namespace DeferredRendering
	{
		...
		protected:
		    ...
		    virtual void compute_post_processing(VkCommandBuffer command_buffer) const;

		    virtual void begin_present_pass(VkCommandBuffer command_buffer, unsigned int imageIndex) const;
		    virtual void present_pass(VkCommandBuffer command_buffer) const;
		    virtual void end_present_pass(VkCommandBuffer command_buffer, unsigned int imageIndex) const;
		...
		protected:
		    ...
		    VkFormat m_PresentPipeline_RenderingFormat = VK_FORMAT_UNDEFINED; //If left undefined, engine will use the default one from swapchain.
