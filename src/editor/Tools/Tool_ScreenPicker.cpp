...
//
//
// 	m_buffers.resize(SmoothieCore::getFramesInFlightCount());
...
//
// 	m_uv.x = glm::clamp((mousePosWin.x / winSize.x), 0.0f, 1.0f);
// 	m_uv.y = 1.0f - glm::clamp((mousePosWin.y / winSize.y), 0.0f, 1.0f);
// }
//
